  ...
  return (
    <div className="min-h-screen pt-24 lg:pt-32">
      <PageMeta
        ...
        description="Stills from the story — portraits, lifestyle, events, and documentary photography from Flashbuzz, captured with the same cinematic eye we bring to film."
