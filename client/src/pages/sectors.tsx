...
export default function Sectors() {
  return (
    <div className="min-h-screen pt-24 lg:pt-32">
      <PageMeta
        title="Sectors | Flashbuzz"
        description="Recruitment, financial services, manufacturing, motorsport, and scientific & tech—Flashbuzz brings sector-specific documentary storytelling to every brief."
