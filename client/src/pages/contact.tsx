...
export default function Contact() {
  return (
    <div className="min-h-screen pt-24 lg:pt-32">
      <PageMeta
        title="Contact | Flashbuzz"
        description="Tell Flashbuzz about your project and get a quote. Documentary-craft video production based in Banbury, Oxfordshire. We respond within 24 hours."
